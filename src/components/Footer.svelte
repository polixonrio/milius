...
>
		...
		<div class="mx-6 py-10 text-center md:text-left">
			<div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
				...
				<!-- Products section -->
				<div class="table-auto justify-center mx-auto justify-items-center">
          <h6 class="text-uppercase text-bold mb-4 text-center">
            WORKING HOURS
          </h6>
          <tbody>
            <tr>
		...
		<!--Copyright section-->
		<div class="bg-neutral-200 p-6 text-center dark:bg-transparent">
			<span>©© 2021-2023 Asterisc.in™</span>
			<a
