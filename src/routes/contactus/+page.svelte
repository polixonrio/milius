<section class="bg-gray-200 dark:bg-gray-900">
	<div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
		<section class="bg-gray-200 dark:bg-gray-900 relative z-10 overflow-hidden py-20 lg:py-[120px]">
					...
					<div class="w-full px-4 lg:w-1/2 xl:w-6/12">
						<div class="mb-12 mx-auto max-w-[570px] lg:mb-0">
							...
							<div class="mb-8 flex w-full max-w-[370px]">
								...
								<div class="w-full">
									<p class="text-black dark:text-white mb-1 text-left text-xl font-bold">
										Our Location
									</p>
									<p
							...
							<div class="mb-8 flex w-full max-w-[370px]">
								...
								<div class="w-full">
									...
									<p class="text-black dark:text-white text-left font-bold text-base">
										+91 77448 22228
									</p>
								</div>
							</div>
